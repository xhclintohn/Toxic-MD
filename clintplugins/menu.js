...
`;
    ...
    try {
      ...
      if (audioFiles.length === 0) {
        ...
        repondre(`𝐍𝐨 𝐚𝐮𝐝𝐢�{o 𝐟𝐢𝐥𝐞𝐬 𝐟𝐨𝐮𝐧𝐝 𝐢𝐧 𝐱𝐡_𝐜𝐥𝐢𝐧𝐭𝐨𝐧 𝐟𝐨𝐥𝐝𝐞𝐫`);
        return;
      }
