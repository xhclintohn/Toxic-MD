...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      repondre("🔄 𝐏𝐫𝐨𝐜𝐞𝐬𝐬𝐢𝐧𝐠 𝐲𝐨𝐮𝐫 𝐁𝐥𝐨𝐨𝐝 𝐥𝐨𝐠𝐨...");
      const result = await mumaker.textpro(
...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    try {
      if (!arg || arg.length === 0) {
        repondre(
          `🔹 𝐄𝐱𝐚𝐦𝐩𝐥𝐞: ${prefixe}deepsea 𝐓𝐨𝐱𝐢𝐜\n\n𝐂𝐫𝐞𝐚𝐭𝐞 𝐚 𝐦𝐲𝐬𝐭𝐞𝐫𝐢𝐨𝐮𝐬 𝐃𝐞𝐞𝐩𝐬𝐞𝐚 𝐥𝐨𝐠𝐨 𝐰𝐢𝐭𝐡 𝐲𝐨𝐮𝐫 𝐧𝐚𝐦𝐞!`
        );
        return;
      }
      repondre("🔄 𝐏𝐫𝐨𝐜𝐞𝐬𝐬𝐢𝐧�{g 𝐲𝐨𝐮𝐫 𝐃𝐞𝐞𝐩𝐬𝐞𝐚 𝐥𝐨𝐠𝐨...");
      const result = await mumaker.textpro(
...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      repondre(`❌ 𝐎𝐨𝐩𝐬! 𝐒�{o𝐦𝐞𝐭𝐡𝐢𝐧𝐠 𝐰𝐞𝐧𝐭 𝐰𝐫𝐨𝐧𝐠: ${e.message}`);
    }
  }
);
...
module.exports = { zokou }; // Export zokou to ensure it’s available if needed